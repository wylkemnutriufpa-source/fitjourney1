...
export const foodCatalog: Record<FoodCategory, CatalogFood[]> = {
  Proteínas: [
    ...
    { foodKey: "whey-protein", name: "Whey protein", qty: 30, unit: "g", kcal: 120, scaleGroup: "protein" },
  ],
  Carboidratos: [
  ...
  Grãos: [
    { foodKey: "arroz-branco", name: "Arroz branco cozido", qty: 100, unit: "g", kcal: 128, scaleGroup: "carb" },
    { foodKey: "arroz-integral", name: "Arroz integral cozido", qty: 100, unit: "g", kcal: 124, scaleGroup: "carb" },
    { foodKey: "feijao-cozido", name: "Feijão cozido", qty: 80, unit: "g", kcal: 60, scaleGroup: "protein" },
    { foodKey: "lentilha-cozida", name: "Lentilha cozida", qty: 80, unit: "g", kcal: 92, scaleGroup: "protein" },
    { foodKey: "grao-de-bico", name: "Grão-de-bico", qty: 80, unit: "g", kcal: 130, scaleGroup: "protein" },
    ...
    { foodKey: "quinoa-cozida", name: "Quinoa cozida", qty: 80, unit: "g", kcal: 96, scaleGroup: "carb" },
  ],
  Sementes: [
